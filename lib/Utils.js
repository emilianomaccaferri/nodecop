...
const key = 'ciao' // dummy key | WARNING: ENCRYPTION WON'T  BE DONE LIKE THIS WHEN NODECOP WILL EXIT ITS BETA STATUS, I KNOW IT'S INSECURE AND NOT VERSATILE DON'T FIX THIS
  ...
  return new Promise(
    ...
    (resolve, reject) => {
      ...
      try{
        ...
        var b = Buffer.from('{"profiles": {}, "items": {}}', 'utf-8');
        var enc = encrypt(b);
